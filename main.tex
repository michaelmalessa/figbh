...
\begin{enumerate}[noitemsep]
	...
	\item Nouns with enclitic personal pronouns, e.g., \foreignlanguage{hebrew}{בֵּיתִי} \textit{my house} (→ \hyperref[nouns with enclitic personal pronouns]{8.2})
...
12~~\foreignlanguage{hebrew}{וַיַּעַזְבוּ אֶת־יְהוָה} \hspace{0.3cm}
	...
	\section{Nouns with Enclitic Personal Pronouns} \label{nouns with enclitic personal pronouns}
...
The very frequent verb \foreignlanguage{hebrew}{נתן} \textit{to give} has the exceptional vowel pattern \textit{a--i} in the prefix conjugation Qal: \textit{*yattin > yittēn} \foreignlanguage{hebrew}{יִתֵּן} \textit{he will give} (with attenuation of \textit{a > i} in closed unstressed syllable).
...
\begin{center}
	...
	In the impv.\ m.\ sg.\ and the inf.\ cs., the \foreignlanguage{hebrew}{א} takes \textit{ḥatef segol}. In the impv.\ \foreignlanguage{hebrew}{אֱמֹר} the original vowel \textit{ō < u} is preserved because there was no need for dissimilation as in the prefix conjugation.
...
Instead of weak forms with connecting vowel between the second root consonant and the suffix there are also forms without connecting vowel, e.g., \foreignlanguage{hebrew}{תָּ֑מְנוּ} \textit{we have been consumed} (1 c.\ pl.\ suffix conjugation Qal from \foreignlanguage{hebrew}{חמם}; Jer 44:18).
...
\section{The Hiphil Binyan} \label{hiphil binyan}
...
\section{The Piel Binyan} \label{piel binyan}
...
8~~\foreignlanguage{hebrew}{וְעַתָּ֖ה מַמְלַכְתְּךָ֣ לֹא־תָק֑וּם בִּקֵּשׁ֩ יְהוָ֨ה ל֜וֹ אִ֣ישׁ כִּלְבָב֗וֹ וַיְצַוֵּ֨הוּ יְהוָ֤ה לְנָגִיד֙ עַל־עַמּ֔וֹ כִּ֚י לֹ֣א שָׁמַ֔רְתָּ אֵ֥ת אֲשֶֽׁר־צִוְּךָ֖ יְהוָֽה׃}  \hspace{0.3cm}
...
\selectlanguage{english}
	...
	\hspace*{-0.5cm}\begin{longtable}{p{0.075\linewidth} p{0.1\linewidth}p{0.725\linewidth}}
		...
		& \foreignlanguage{hebrew}{וְיֹלַדְתְּ} & This appears to be a \textit{lectio mixta}. One can either read \foreignlanguage{hebrew}{וְיֹלֶדֶת} or \foreignlanguage{hebrew}{וְיָלַדְתְּ} (JM §§\,89\,\textit{j}, 16\,\textit{g}). The vowel signs of the Masoretic Text combine both forms. Other grammars accept this forms as participle fem.\ sg.\ without a helping vowel to break up the final consonant cluster. \\
		...
		16:14 & \foreignlanguage{hebrew}{קָדֵשׁ} & (and \foreignlanguage{hebrew}{בֶּרֶד}) names of places
	\end{longtable}
...
Verbs I gutt.\ and II gem.\ verb \foreignlanguage{hebrew}{חתת} have Niphal suffix conjugation forms like the expected \foreignlanguage{hebrew}{נָחָ֑ר} \textit{it was burned} (3 masc.\ sg.\ SC, pausal form; from the verb \foreignlanguage{hebrew}{חרר}; Ezek 15.5) or \foreignlanguage{hebrew}{נִחַת} (3 masc.\ sg.\ SC; from the verb \foreignlanguage{hebrew}{חתת}; with loss of the gemination of the first root consonant). In the prefix conjugation forms with a lengthened prefix vowel as result of the loss of the gemination are found, e.g., \foreignlanguage{hebrew}{יֵחַת} (\textit{*yinḥat > *yiḥḥat > yēḥat}).
...
Forms without a connecting vowel between the second root consonant and the consonantal suffix are also found, e.g., \foreignlanguage{hebrew}{וְהֵפַרְתָּ֫ה} \textit{and you shall make ineffectual} (2\,Sam 15:34). In this form the gemination of the second root consonant is lost.
	
Aramaizing forms with a geminated first root occur a number of times, e.g., \foreignlanguage{hebrew}{וַיַּסֵּב} \textit{and he caused to go around} (Josh 6:11), \foreignlanguage{hebrew}{וַיַּסֵּבּוּ} \textit{and they brought} (1\,Sam 5:8), \foreignlanguage{hebrew}{יַתֵּם} \textit{let him count out the entire amount} (2\,Kgs 22:4), \foreignlanguage{hebrew}{יַחֵל} (with loss of the gemination of the /ḥ/ and preservation of the short vowel) \textit{let him [not] make invalid} (Num 30:3).
...
Contamination with forms of II\,\textit{w/y} verbs may happen occasionally, e.g., \foreignlanguage{hebrew}{הִבּוֹז תִּבּוֹז} (verb \foreignlanguage{hebrew}{עזז} Ni.) \textit{[the earth] will be plundered} (Isa 24:3), \foreignlanguage{hebrew}{יַשִּׁים} (\foreignlanguage{hebrew}{שׁמם} Hi.) \textit{he will devastate} (Jer 49:20). Other deviating forms are attested as well.
...
\begin{longtable}{>{\raggedleft}p{0.35\linewidth} p{0.55\linewidth}}
	...
	\foreignlanguage{hebrew}{וְשָׁמַרְתָּ אֶת־חֻקָּיו וְאֶת־מִצְוֹתָיו אֲשֶׁר אָנֹכִי מְצַוְּךָ הַיּוֹם אֲשֶׁר יִיטַב לְךָ וּלְבָנֶיךָ אַחֲרֶיךָ} & \textit{\dots \space and you shall keep his statutes and his commandments that I command you today, in order that it may be well with you and you children after you} (Deut 4:40) \\
...
\begin{multicols}{2}
	...
	\setbox\ltmcbox\vbox{
		...
		\begin{longtable}{>{\raggedleft}p{0.25\linewidth} p{0.65\linewidth}}
			...
			\foreignlanguage{hebrew}{אֶרֶז} & \textit{cedar} \\
			\foreignlanguage{hebrew}{אֹרַח} & \textit{way, path} \\
			\foreignlanguage{hebrew}{אֲרִי} & \textit{lion} \\
